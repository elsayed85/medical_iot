...
<body>
    ...
    <audio controls loop autoplay id="heart">
            <source src="/audio/heart_alive.mp3" type="audio/mpeg">
        ...
        setInterval(function () {
            $.ajax({
                ...
                if(json.status == 1){
                    ...
                    var bpm = json['last'].bpm;
                    var created_at = json['last'].created_at;
                    if(!$.isEmptyObject(json) && json.status == 1 ){
                        rate = bpm/100;
                        if(dataARR.length > 0){
                            if(dataARR.length > 0 && dataARR[dataARR.length - 1].created_at != created_at){
                                dataARR.push(json['last']);
                                toastr.success('', 'Bpm:' + bpm + " since " + time_ago(created_at)  , { "progressBar": true , timeOut: 3000 });
                                if(bpm > 0 && bpm < 20){
                                    heart.playbackRate = 2;
                                    toastr.warning('betwwen 1 amd 20', 'Your Bpm is Low!! At' + time_ago(created_at) , { "closeButton": true  , positionClass: 'toastr toast-bottom-left', containerId: 'toast-bottom-left', timeOut: 3000});
                                    console.log('Your Bpm is Low!! At' + created_at);
                                }
                                else if(bpm >= 20 && bpm < 60){
                                    heart.playbackRate = 1.5;
                                    toastr.info('betwwen 20 amd 50', '', { "closeButton": true  , positionClass: 'toastr toast-bottom-left', containerId: 'toast-bottom-left', timeOut: 3000});
                                }
                                else if(bpm >= 60 && bpm < 100){
                                    heart.playbackRate = 1;
                                    toastr.success('betwwen 60 amd 100', '', { "closeButton": true  , positionClass: 'toastr toast-bottom-left', containerId: 'toast-bottom-left', timeOut: 3000});
                
                                }
                                else if(bpm == 0){
                                    heart.playbackRate = 0;
                                    toastr.error('Your heart beat is ZERO!', 'YOU ARE DEAD!', { "closeButton": true  , positionClass: 'toastr toast-bottom-left', containerId: 'toast-bottom-left', timeOut: 3000});
                                }
                            }
                        }
                        else{
                            dataARR.push(json);
                            toastr.info('New Bpm!', 'Bpm:' + bpm + " At " + time_ago(created_at)  , { "progressBar": true });
                            if(bpm > 0 && bpm < 20){
                                toastr.warning('betwwen 1 amd 20', 'Your Bpm is Low!!', { "closeButton": true  , positionClass: 'toastr toast-bottom-left', containerId: 'toast-bottom-left' , timeOut: 3000 });
                                heart.playbackRate = 2;
                            }
                            else if(bpm >= 20 && bpm < 60){
                                heart.playbackRate = 1.5;
                    ...
                    @endif
                    $(".st24, .st25, .st26, .st27, .st29, .st31, .st37, .st40, .st43, .st112, .st130, .st133, .st134, .st135, .st140, .st144, .st145, .st147, .st157, .st189, .st190, .st191, .st197, .st340, .st341, .st342, .st343, .st344, .st345").css("animation", "fill-ani 2s ease-in 2.5s backwards, pulse-grow-top " + (rate) + "s ease-in-out 3.5s infinite alternate");
                        $(".st94, .st102, .st104, .st209, .st215, .st216, .st217, .st221, .st254, .st257, .st272, .st273, .st274, .st275, .st276, .st277, .st279, .st280, .st281, .st285, .st290, .st291, .st292, .st293, .st295, .st299, .st312, .st319, .st325, .st327, .st331, .st335").css("animation", "fill-ani 2s ease-in 2s backwards, pulse-grow-top " + (rate) + "s ease-in-out 3s infinite alternate");
                        $(".st84, .st85, .st86, .st87, .st88, .st89, .st90, .st91, .st92, .st93, .st96, .st106, .st107, .st108, .st109, .st110, .st111, .st113, .st116, .st119, .st120, .st122, .st124, .st125, .st126, .st127, .st128, .st152, .st154, .st159, .st160, .st161, .st162, .st163, .st164, .st165, .st168, .st169, .st194, .st195, .st210, .st212, .st214, .st218, .st220, .st222, .st223, .st224, .st225, .st226, .st228, .st229, .st230, .st231, .st253, .st262, .st263, .st264, .st265, .st266, .st289, .st294, .st296, .st297, .st298, .st300, .st302, .st304, .st305, .st306, .st307, .st308, .st309, .st310, .st311, .st313, .st314, .st316, .st317, .st318, .st320, .st321, .st322, .st323, .st326, .st329, .st349, .st350, .st351, .st352, .st353").css("animation", "fill-ani 2s ease-in 3s backwards, pulse-grow-bottom " + (rate) + "s ease-in-out 3s infinite alternate");
                        if (previous && current && previous !== current) {
                            if(bpm > 0 && bpm < 20){
                                heart.playbackRate = 5;
                            }
                            else if(bpm >= 20 && bpm < 60){
                                heart.playbackRate = 4;
                            }
                            else if(bpm >= 60 && bpm < 100){
                                heart.playbackRate = 2;
                            }
